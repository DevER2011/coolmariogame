...
function startgame(){
GameStatus = "start";
document.getElementById("status").innerHTML = "Loading or is it?";
}
function game(){
console.log("noseX =" +noseX+ "noseY ="+noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Why are you reading this when it clearly says play on the button", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
